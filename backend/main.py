...
from prep_coach_builder import (
    build_prep_coach_system_prompt,
    build_prep_coach_context,
    format_notes_for_dm_context
)
...
@app.get("/campaigns/{campaign_id}/dm-prep")
...
@app.post("/campaigns/{campaign_id}/dm-prep/message")
...
@app.post("/campaigns/{campaign_id}/dm-prep/note")
...
@app.put("/campaigns/{campaign_id}/dm-prep/note/{note_id}")
...
@app.delete("/campaigns/{campaign_id}/dm-prep/note/{note_id}")
...
@app.post("/campaigns/{campaign_id}/dm-prep/pin")
...
@app.delete("/campaigns/{campaign_id}/dm-prep/pin/{pin_id}")
...
@app.delete("/campaigns/{campaign_id}/dm-prep/conversation")
